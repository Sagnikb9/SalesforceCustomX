                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div><a href="<%=request.getContextPath()%>/custom_object_dataloader"><button class="btn btn-warning">Close</button></a>
        ...
        <div id="file" class="card">
            <div class="body" style="text-align: center">
                    ...
                    <div class="btn-group">    
                            ...
                            <div><a href="<%=request.getContextPath()%>/custom_object_bulk_upload_insert_display"><button id="loginbtn" class="btn btn-primary" type="submit">INSERT</button></a>
                            <a href="<%=request.getContextPath()%>/custom_object_bulk_upload_update_display"><button id="loginbtn" class="btn btn-primary" type="submit">UPDATE</button></a>
                            <a href="<%=request.getContextPath()%>/custom_object_bulk_upload_delete_display"><button id="loginbtn" class="btn btn-primary" type="submit">DELETE</button></a></div>
                        ...
                        <div class="btn-group" style="float: right;">
                            ...
                            <a href="<%=request.getContextPath()%>/custom_object_dataloader"><button class="btn btn-warning">Close</button></a>
